...
class Photo extends Model {
    ...
    protected $fillable = ['name', 'description', 'file_name', 'share_id', 'attach_id', 'file_size', 'user_id', 'folder_id', 'serialized_editor_state', 'width', 'height', 'password', 'created_at', 'updated_at', 'deleted_at','price'];
